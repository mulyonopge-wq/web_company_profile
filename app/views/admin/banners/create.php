...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold text-dark mb-1">Tambah Banner Baru</h3>
        <p class="text-secondary small mb-0">Tambahkan gambar slider dan teks promosi baru.</p>
    </div>
...
<div class="card border rounded-4 p-4 shadow-sm bg-white" style="max-width: 700px;">
    <form action="<?= UrlHelper::base('admin/banners/store') ?>" method="POST" enctype="multipart/form-data">
        <?= CsrfHelper::field() ?>

        <div class="mb-3">
            <label class="form-label small fw-semibold">Judul Banner *</label>
            <input type="text" name="title" class="form-control" required placeholder="Contoh: Solusi Jaringan Bisnis & Kantor Modern">
        </div>

        <div class="mb-3">
            <label class="form-label small fw-semibold">Subtitle / Deskripsi</label>
            <textarea name="subtitle" rows="3" class="form-control" placeholder="Teks penjelasan singkat di bawah judul..."></textarea>
        </div>

        <div class="mb-3">
            <label class="form-label small fw-semibold">Gambar Banner (Rekomendasi rasio 16:9, min. 1200x600px)</label>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="button_text" class="form-control" value="Lihat Produk">
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-semibold">URL Tombol</label>
                <input type="text" name="button_url" class="form-control" value="/produk">
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-primary rounded-pill px-4">
            <i class="bi bi-floppy-fill me-1"></i> Simpan Banner
        </button>
    </form>
</div>
